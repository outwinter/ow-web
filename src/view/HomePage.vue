<template>
  <div id="HomePage">
    ...
    <div id="index-partner">
      <span><i class="iconfont"></i>合作伙伴</span>
      <div class="swiper-container swiper-container-horizontal" id="partner">
        <div class="swiper-wrapper">
          <div
          ...
          >
            <a
              ...
              target="_blank"
            >
              <img src="/upload/202009/12/202009121416568974.jpg" alt=""
            /></a>
          </div>
        </div>
        <!-- Add Pagination -->
